...
function chainPromises(/* array, action */) {
  ...
  // return Promise.resolve(array.reduce((acc, promise, index) => {
  //   if (index === 0) return promise.then((result) => result).catch();
  //   return promise.then((result) => action(acc, result)).catch(() => { });
  // }));
}
